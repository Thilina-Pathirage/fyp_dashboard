...
import { Button, TextField, Select, MenuItem, FormControl, Stack, IconButton } from "@mui/material";
...
export default function AddEmployeeModal() {
  ...
  return (
    <div>
      <Button onClick={handleOpen} className='create-new-user-btn' endIcon={<AddIcon />} variant="contained" color="success">
        New Employee
      </Button>
      <Modal
        open={open}
